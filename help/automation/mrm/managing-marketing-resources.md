...
1. 将该文件拖放到“营销资源”窗口中，以将其上传到Campaign服务器。 您也可以使用 **[!UICONTROL Upload file to server...]** 链接。
...
使用 **[!UICONTROL Assigned to]** 中的下拉列表 **[!UICONTROL Edit]** 选项卡以选择负责该资源的操作员。
...
>
>此 **[!UICONTROL Audit]** 选项卡允许您监视对资源执行的任何操作：批准、拒绝审批、相关注释或发布。
...
更新资源后，单击 **[!UICONTROL Lock]** 按钮以再次对所有操作员可用。
...
在中了解详情 [论坛](discussion-forums.md) 部分。
...
* 如果资源通过营销资源创建任务进行管理，则当任务设置为时，将执行该资源 **[!UICONTROL Finished]**，只要 **[!UICONTROL Publish the marketing resource]** 在任务中，复选框处于选中状态。 [了解详情](creating-and-managing-tasks.md#marketing-resource-creation-task))
...
营销资源可与营销活动相关联，前提是已 [活动模板](../campaigns/marketing-campaign-templates.md).
...
1. 添加库存行，然后选择相应的营销资源。
   ...
   您可以通过以下方式编辑选定的资源 **[!UICONTROL Edit the link]** 图标进行选择后，该图标将位于资源的右侧。
