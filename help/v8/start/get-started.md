...
?? 用户档案管理基础知识在[本节](audiences.md)中有说明。

?? 请参阅[本节](import.md)以了解如何向 Campaign 添加用户档案。
...
?? 请参阅[本节](audiences.md)以了解关于分段、受众创建和个性化的更多信息。
...
?? 请参阅[本节](campaigns.md)以了解如何设计、计划和执行活动。
...
?? 请参阅[本节](../config/workflows.md)以了解如何设计和执行工作流。
...
?? 请参阅[本节](reporting.md)以详细了解报告和跟踪功能。
...
?? 请参阅[本节](../connect/integration.md)以了解如何与 Adobe 服务和解决方案集成。
...
?? 已经熟悉了 Campaign Classic？在[此页面](capability-matrix.md)中了解 Campaign Classic 和 Campaign v8 之间的主要差异。
...
↗️  请参阅 [Campaign Classic v7 文档](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/starting-with-adobe-campaign/campaign-workspace/adobe-campaign-workspace.html?lang=zh-Hans){target=&quot;_blank&quot;}以了解如何使用 Campaign 工作区

↗️  请参阅 [Campaign Classic v7 文档](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/starting-with-adobe-campaign/campaign-workspace/adobe-campaign-ui-lists.html?lang=zh-Hans){target=&quot;_blank&quot;}以了解如何自定义列表

您还可以通过 Web 访问某些功能。

?? [了解关于 Campaign Web Access 的更多信息](../start/connect.md#web-access)。
