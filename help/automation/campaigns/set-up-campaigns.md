...
1. **创建您的第一个营销活动**
营销策划可集中与营销策划相关的所有元素：投放、定位规则、成本、导出文件、相关文档等。 每个营销策划都附属于一个项目。 在本节[中了解如何创建营销活动](marketing-campaign-create.md#create-a-campaign)。

1. **选择受众**
可以从列表导入受众，也可以使用查询在营销活动工作流中构建受众。 在本节[中了解如何定义营销活动](marketing-campaign-target.md#select-the-target-population)的目标受众。

1. **创建投放**
在营销活动中编排跨渠道投放。 通过个性化的电子邮件、短信、推送通知和应用程序内消息，简化您与Adobe Campaign的通信。 您还可以添加直邮投放。 在本节[中了解如何在营销活动](marketing-campaign-deliveries.md)中创建、验证和监视投放。

1. **设置适当流程**
定义审阅人并配置审批流程以监控活动流程：定位、内容、预算、提取和验证发送。 在此部分[中了解如何设置审批](marketing-campaign-approval.md)。
