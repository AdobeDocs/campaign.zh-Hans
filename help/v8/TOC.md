...
+ 发行说明{#releases}
   ...
   + 之前的发行说明 {#previous-rn}
      + [2023 版](start/release-notes-2023.md)
      + [2022 版](start/release-notes-2022.md)
      + [2021 版](start/release-notes-2021.md)
...
+ 发送消息 {#send}
   ...
   + 推送通知 {#push}
      ...
      + [设计 Android 富推送投放](send/rich-push.md)
...
+ 隐私和安全管理 {#privacy}
   ...
   + [增强的安全加载项](config/enhanced-security.md)
+ 决策管理 {#offers}
