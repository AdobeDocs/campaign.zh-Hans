...
[了解关于静态和非静态SOAP方法的更多信息](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}。
...
使用`DeleteCollection`方法。 [了解详情](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}。
...
循环包括一个本地收件人变量。 对于收件人集合中返回的每个收件人，都会打印出收件人的电子邮件。 [了解有关`logInfo`函数的更多信息](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}。
...
* 若要发布事件，您可以使用静态`PostEvent`方法。 [了解详情](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}。
...
1. 定义查询：
   ...
   * 在对应的架构上使用`create`方法检索实体，例如`xtk:workflow`架构。 [了解详情](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}。
   * 使用`queryDef`方法发出SQL查询。

1. 使用`ExecuteQuery`方法运行查询。 [了解详情](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}。
...
* [SOAP调用示例](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
* 方法：
  * [创建](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
  * [删除收藏集](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
  * [执行查询](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
  * [Postevent](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
  * [写入](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
* [logInfo函数](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
