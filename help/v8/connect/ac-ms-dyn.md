...
1. 取得您的Dynamics 365應用程式（使用者端） ID。 [了解详情](#get-client-id-microsoft)
1. 產生Microsoft Dynamics憑證金鑰識別碼和金鑰ID。 [了解详情](#config-certificate-key-id)
1. 設定許可權。 [了解详情](#config-permissions-microsoft)
1. 建立應用程式使用者。 [了解详情](#create-app-user-microsoft)
1. 編碼私密金鑰。 [了解详情](#configure-acc-for-microsoftt)
