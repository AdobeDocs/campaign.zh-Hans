...
1. **创建投放**
   ...
   要了解如何创建和开始营销活动投放，请参阅[此页面](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-deliveries.html?lang=zh-Hans){target="_blank"}。

   您可以将各种文档与活动关联起来：报告、照片、网页、图表等。

   要了解相关文档的更多信息，请参阅[此页面](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-assets.html?lang=zh-Hans){target="_blank"}。
