...
在上了解有关Adobe Campaign和Experience Cloud触发器的更多信息 [本页](https://experienceleague.adobe.com/docs/campaign-classic/using/integrating-with-adobe-experience-cloud/experience-triggers/about-triggers.html?lang=en).
