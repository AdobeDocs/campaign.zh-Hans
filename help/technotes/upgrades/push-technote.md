...
1. 过渡HTTP v1完成后，您必须更新 **投放模板** 以增加Android推送消息数量。 为此，请浏览到Android投放模板的属性，然后在 **投放** 选项卡，设置 [消息批次数量](../../v8/send/configure-and-send.md#delivery-batch-quantity) 到 **256**. 将此更改应用于您的Android投放使用的所有投放模板，以及您所有现有的Android投放。
