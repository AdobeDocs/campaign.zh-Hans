...
A **[!UICONTROL Query]** 活動可讓您選取基本資料來建立目標母體。 如需详细信息，请参阅[此部分](query.md#create-a-query)。
...
除了目標維度，篩選維度也可讓您指定所收集資料的性質。 请参阅[此小节](targeting-workflows.md#targeting-and-filtering-dimensions)。
