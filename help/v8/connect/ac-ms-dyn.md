---
title: 使用Campaign和Microsoft Dynamics
...
在 [Microsoft Dynamics 365文档](https://docs.microsoft.com/powerapps/developer/common-data-service/walkthrough-register-app-azure-active-directory).
