...
1. 单击 **[!UICONTROL Finish]**。然後，在 **[!UICONTROL General]** 標籤中的 **[!UICONTROL Split]** 活動，按一下 **[!UICONTROL Generate complement]** 在 **[!UICONTROL Results]** 類別。
...
1. 单击 **[!UICONTROL Ok]**。您的擴充功能現已準備就緒。
...
1. 单击 ![](assets/uc_enrichment_16.png)。選取 **[!UICONTROL Target extension]** 然後使用先前建立的自訂有效日期 **[!UICONTROL Enrichment]** 活動，將您的擴充功能新增至formatDate運算式。
