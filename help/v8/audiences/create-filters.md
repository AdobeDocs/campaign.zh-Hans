...
如果您需要重複使用篩選器，請建立 **進階篩選** 並儲存。 [了解详情](#advanced-filters)。
...
* 瞭解如何在中建立生日電子郵件對象  [此頁面](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/deliveries/send-a-birthday-email.html?lang=zh-Hans).
