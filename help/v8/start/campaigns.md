...
* **营销活动**：营销活动集中了与营销活动相关的所有元素：投放、定位规则、成本、导出文件、相关文档等。每个营销策划都附属于一个项目。

* **项目**：项目允许您定义日历期间的营销行动：发布、调查意见、忠诚度等。每个项目都包含链接到日历的营销活动，日历提供了概览。
...
Adobe Campaign提供了一个&#x200B;**分布式营销**&#x200B;附加功能，用于在中心实体（总部、营销部门等）和本地实体（销售点、地区代理等）之间 以及地方实体（商店、区域机构等）。 此合作基于称为 **[!UICONTROL List of campaign packages]** 的共享工作区，在其中，中央实体可以将其设计的营销活动模板提供给本地实体。
