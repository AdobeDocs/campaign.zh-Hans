...
每个组织实体都包含订单审批流程中涉及的标识信息（标签、内部名称、联系信息等）和组。 这些在&#x200B;**[!UICONTROL General]**&#x200B;选项卡中的&#x200B;**[!UICONTROL Notifications and approvals]**&#x200B;部分中定义。
...
1. 创建Web窗体(Adobe或外联网)，以便您显示本地化参数、评估目标和预算，以及预览内容和批准订单。
